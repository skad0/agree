...
test("production does not require a ledger store; incomplete ledger config still fails closed", () => {
  const base = { NODE_ENV: "production", SESSION_SECRET: "session", TRUSTED_PROXY: "cloudflare", TRUSTED_PROXY_SECRET: "edge-secret-012345678901234567890123", APP_BASE_URL: "https://example.org", PRIVACY_CONTACT_EMAIL: "privacy@ops.test" };
