...
| Machine CEC feed for 26 is **not** verified | Live `package_show` for CKAN `candidates-lists` on 2026-09-12 returned **only** resources for Knessets **19–24**; `www.gov.il/.../election-candidates26` returned **HTTP 403** | Do not treat historical 19–24 package rows as the 2026 closed list. Prefer an **official artifact** import into a **draft** publication until a verified DataStore/export contract exists. |
