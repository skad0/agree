...
Date: 2026-09-07. Status: slice 1 schema and shared read-model foundation only. Visual directory, search, filters, autosuggest, multiselect, and stance UI are not implemented. Single-recipient sending is unchanged.
